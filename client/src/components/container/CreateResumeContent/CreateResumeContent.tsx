...
import './CreateResumeContent.scss';
...
import socials, { Description, Type } from '@StaticData/socials';
import expirenceResume from '@StaticData/experience';
...
import { CategoryType, CategoryDescription } from '@Types/CategoryMusicians';

const CreateResumeContent = ({ toggleMenuClass }: ComponentWithLeftMenu) => {
    ...
    return (
        <div className='CreateResumeContent'>
...
export default CreateResumeContent;
